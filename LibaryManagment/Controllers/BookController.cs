...
namespace LibaryManagment.Controllers
{
    public class BookController : Controller
    {
        ...
        public IActionResult Index(string searchTerm, int? categoryId, string availability, int? year)
        {
            ...
            {
                query +=
                    " AND (BookName LIKE @searchTerm OR AuthorName LIKE @searchTerm OR Publisher LIKE @searchTerm)";
            ...
            {
                var cmdCat =
                    new MySqlCommand("SELECT DISTINCT CategoryID, CategoryName FROM Categories ORDER BY CategoryName",
                        con2);
                con2.Open();
            ...
            {
                var cmdYear = new MySqlCommand("SELECT DISTINCT Year FROM Books ORDER BY Year DESC", con3);
                con3.Open();
